...
time4post = hF.convert_to_RFC_datetime(year=2020,month=10,day=29,hour=7,minute=15 )
post_new_video(path2video = 'E:\\PODCASTS TRECHOS\\15--27_10_20-18_34_30.mp4',
    path2thumb = 'E:\\TRECHOS THUMBS\\FALOU QUE IA ME CONVIDAR E NEM CHAMOU.png', infos={'title':'this is the title fo the video in yt',
                                                                                         'description':'random desc','publishAt': f'{time4post}'} )